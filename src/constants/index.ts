...
import type { PlanetName, ZodiacElement, ZodiacModality, AspectType } from '../types';
 ...
 * 星座属性映射表（元素和模式）
 */
export const SIGN_PROPERTIES: Record<typeof ZODIAC_SIGNS[number], { element: ZodiacElement; modality: ZodiacModality }> = {
 ...
 * 星座守护星映射表
 */
export const SIGN_RULERS: Record<typeof ZODIAC_SIGNS[number], PlanetName> = {
  Aries: 'Mars',
  Taurus: 'Venus',
  Gemini: 'Mercury',
  Cancer: 'Moon',
 ...
 * 元素原型描述映射表
 */
export const ELEMENT_ARCHETYPES: Record<ZodiacElement, string> = {
 ...
 * 相位容许度（度）
 */
export const ASPECT_ORB_LIMIT = 8;

/**
 * 宫位系统标识（Placidus）
 */
export const HOUSE_SYSTEM = 'P' as const;